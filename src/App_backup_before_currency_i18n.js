      ...
      <main className="main-content">
        ...
        {tab === "settings" && (
          <section className="card">
            ...
            <div className="card-title">{tr("settings")} · 출입금 유형 편집</div>
          ...
          <section className="card">
            ...
            <div className="chart-grid">
              <div className="chart-box">
                <div className="card-title">{tr("income")} {tr("category")}</div>
              ...
              <div className="chart-box">
                <div className="card-title">{tr("expense")} {tr("category")}</div>
            ...
            <div className="chart-box wide">
              <div className="card-title">{tr("income")} / {tr("expense")}</div>
              <Bar
                data={{
